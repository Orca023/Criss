...
int main(int argc, char *argv[]) {
    ...
    char *interpreterFile = "";  // 解釋器（Julia、Python、Node.js、Java）的二進制可執行檔啓動時的，配置參數："-p,4,--project=C:/Criss/jl/"
    // interpreterFile = "";  // "-p,4,--project=C:/Criss/jl/";  // 初始預設值;
    // printf("interpreterFile = %s\n", interpreterFile);

    char *configInstructions = "";// 解釋器（Julia、Python、Node.js、Java）的二進制可執行檔啓動時，讀入的脚步文檔（.jl、.py、.js、.class）的，配置參數："interface_Function=http_Server,webPath=C:/Criss/html/,host=::0,port=10001,key=username:password,number_Worker_threads=1,isConcurrencyHierarchy=Tasks"
    // configInstructions = "interface_Function=http_Server,webPath=C:/Criss/html/,host=::0,port=10001,key=username:password,number_Worker_threads=1,isConcurrencyHierarchy=Tasks";  // 初始預設值;
    // printf("configInstructions = %s\n", configInstructions);

    char *executableFile = "";  // 解釋器（Julia、Python、Node.js、Java）的二進制可執行檔啓動路徑參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"、"C:/Criss/Python/Python311/python.exe"、"C:/Criss/py/Scripts/python.exe"、"C:/Criss/Nodejs/node.exe"
    char *scriptFile = "";  // 解釋器（Julia、Python、Node.js、Java）的二進制可執行檔啓動時，讀入的脚步文檔（.jl、.py、.js、.class）的保存路徑參數："C:/Criss/jl/application.jl"、"C:/Criss/py/application.py"、"C:/Criss/js/application.js"

    char *shellCodeScript = "";  // C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/Python/Python311/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/py/Scripts/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
    ...
    // char *executableFileName = "Julia/Julia-1.9.3/bin/julia.exe";  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
    // const int lengthEexecutableFileName = strlen(executableFileName);
    // // printf("%d\n", lengthEexecutableFileName);  // 31

    // char defaultExecutableFilePath[lengthDefaultConfigFileDirectory + 1 + lengthEexecutableFileName + 1];  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
    // snprintf(defaultExecutableFilePath, sizeof(defaultExecutableFilePath), "%s%s%s", defaultConfigFileDirectory, "/", executableFileName);
    // // printf("預設的解釋器二進制可執行檔的啓動路徑爲：\n%s\n", defaultExecutableFilePath);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
    ...
    // char *scriptFileName = "jl/application.jl";  // "C:/Criss/jl/application.jl"
    // const int lengthScriptFileName = strlen(scriptFileName);
    // // printf("%d\n", lengthScriptFileName);  // 56

    // char defaultScriptFilePath[lengthDefaultConfigFileDirectory + 1 + lengthScriptFileName + 1];  // "C:/Criss/jl/application.jl"
    // snprintf(defaultScriptFilePath, sizeof(defaultScriptFilePath), "%s%s%s", defaultConfigFileDirectory, "/", scriptFileName);
    // // printf("預設的解釋器執行的脚本文檔的保存路徑爲：\n%s\n", defaultScriptFilePath);  // "C:/Criss/jl/application.jl"
    ...
    // // printf("預設的解釋器執行的脚本文檔（application.jl）的保存路徑爲：\n%s\n", scriptFile);  // "C:/Criss/jl/application.jl"
    // // const int lengthDefaultScriptFilePath = strlen(scriptFile);
    // // printf("%d\n", lengthDefaultScriptFilePath);  // 77

    // char *interpreterFileName = "jl/";  // "-p,4,--project=C:/Criss/jl/"
    // const int lengthInterpreterFileName = strlen(interpreterFileName);
    // // printf("%d\n", lengthInterpreterFileName);  // 23

    // char defaultInterpreterFilePath[10 + lengthDefaultConfigFileDirectory + 1 + lengthInterpreterFileName + 1];  // "--project=C:/Criss/jl/"
    ...
    // // printf("預設的解釋器啓動時傳入的參數爲：\n%s\n", defaultInterpreterFilePath);  // "--project=C:/Criss/jl/"
    ...
    // // printf("預設的解釋器啓動時傳入的參數爲：\n%s\n", interpreterFile);  // "--project=C:/Criss/jl/"
    ...
    // printf("%d\n", lengthIsBlock);  // 4
    // printf("executableFile = %s\n", executableFile);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"、"C:/Criss/Python/Python311/python.exe"、"C:/Criss/py/Scripts/python.exe"、"C:/Criss/Nodejs/node.exe"
    ...
    // printf("scriptFile = %s\n", scriptFile);  // "C:/Criss/jl/application.jl"、"C:/Criss/py/application.py"、"C:/Criss/js/application.js"
    const int lengthScriptFile = strlen(scriptFile);
    // printf("%d\n", lengthScriptFile);  // 77
    // printf("configInstructions = %s\n", configInstructions);  // "interface_Function=http_Server,webPath=C:/Criss/html/,host=::0,port=10001,key=username:password,number_Worker_threads=1,isConcurrencyHierarchy=Tasks"
    ...
    if (lengthExecutableFile > 0) {
        ...
        char defaultShellCodeScript[lengthExecutableFile + 1 + lengthInterpreterFile + 1 + lengthScriptFile + 1 + lengthConfigInstructions + 1];  // 255 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"

        if (lengthScriptFile == 0) {

            if (lengthInterpreterFile == 0) {

                // char defaultShellCodeScript[lengthExecutableFile + 1];  // 53 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
                snprintf(defaultShellCodeScript, sizeof(defaultShellCodeScript), "%s", executableFile);  // 52 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", defaultShellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
                ...
                shellCodeScript = defaultShellCodeScript;  // C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/Python/Python311/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/py/Scripts/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", shellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"
            ...
            if (lengthInterpreterFile > 0) {
                ...
                // char defaultShellCodeScript[lengthExecutableFile + 1 + lengthInterpreterFile + 1];  // 113 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/"
                snprintf(defaultShellCodeScript, sizeof(defaultShellCodeScript), "%s%s%s", executableFile, " ", interpreterFile);  // 112 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", defaultShellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/"
                const int lengthDefaultShellCodeScript = strlen(defaultShellCodeScript);
        ...
        if (lengthScriptFile > 0) {
            ...
            if ((lengthInterpreterFile == 0) && (lengthConfigInstructions == 0)) {
                ...
                // char defaultShellCodeScript[lengthExecutableFile + 1 + lengthScriptFile + 1];  // 131 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl"
                snprintf(defaultShellCodeScript, sizeof(defaultShellCodeScript), "%s%s%s", executableFile, " ", scriptFile);  // 130 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", defaultShellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl"
                const int lengthDefaultShellCodeScript = strlen(defaultShellCodeScript);
                ...
                // shellCodeScript = strdup(defaultShellCodeScript);  // 函數：strdup(defaultShellCodeScript) 表示，指針傳值，深拷貝，需要 free(shellCodeScript) 釋放内存;
                shellCodeScript = defaultShellCodeScript;  // C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/Python/Python311/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/py/Scripts/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", shellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl"
                // const int lengthDefaultShellCodeScript = strlen(shellCodeScript);
                // printf("%d\n", lengthDefaultShellCodeScript);  // 130
            ...
            if ((lengthInterpreterFile > 0) && (lengthConfigInstructions == 0)) {
                ...
                // char defaultShellCodeScript[lengthExecutableFile + 1 + lengthInterpreterFile + 1 + lengthScriptFile + 1];  // 191 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl"
                snprintf(defaultShellCodeScript, sizeof(defaultShellCodeScript), "%s%s%s%s%s", executableFile, " ", interpreterFile, " ", scriptFile);  // 190 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", defaultShellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl"
                const int lengthDefaultShellCodeScript = strlen(defaultShellCodeScript);
                ...
                // shellCodeScript = strdup(defaultShellCodeScript);  // 函數：strdup(defaultShellCodeScript) 表示，指針傳值，深拷貝，需要 free(shellCodeScript) 釋放内存;
                shellCodeScript = defaultShellCodeScript;  // C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/Python/Python311/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/py/Scripts/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", shellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl"
                // const int lengthDefaultShellCodeScript = strlen(shellCodeScript);
                // printf("%d\n", lengthDefaultShellCodeScript);  // 190
            ...
            if ((lengthInterpreterFile == 0) && (lengthConfigInstructions > 0)) {
                ...
                // char defaultShellCodeScript[lengthExecutableFile + 1 + lengthScriptFile + 1 + lengthConfigInstructions + 1];  // 195 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                snprintf(defaultShellCodeScript, sizeof(defaultShellCodeScript), "%s%s%s%s%s", executableFile, " ", scriptFile, " ", configInstructions);  // 194 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", defaultShellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                const int lengthDefaultShellCodeScript = strlen(defaultShellCodeScript);
                ...
                // shellCodeScript = strdup(defaultShellCodeScript);  // 函數：strdup(defaultShellCodeScript) 表示，指針傳值，深拷貝，需要 free(shellCodeScript) 釋放内存;
                shellCodeScript = defaultShellCodeScript;  // C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/Python/Python311/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/py/Scripts/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", shellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // const int lengthDefaultShellCodeScript = strlen(shellCodeScript);
                // printf("%d\n", lengthDefaultShellCodeScript);  // 194
            ...
            if ((lengthInterpreterFile > 0) && (lengthConfigInstructions > 0)) {
                ...
                // char defaultShellCodeScript[lengthExecutableFile + 1 + lengthInterpreterFile + 1 + lengthScriptFile + 1 + lengthConfigInstructions + 1];  // 255 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                snprintf(defaultShellCodeScript, sizeof(defaultShellCodeScript), "%s%s%s%s%s%s%s", executableFile, " ", interpreterFile, " ", scriptFile, " ", configInstructions);  // 254 // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", defaultShellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                const int lengthDefaultShellCodeScript = strlen(defaultShellCodeScript);
                ...
                // shellCodeScript = strdup(defaultShellCodeScript);  // 函數：strdup(defaultShellCodeScript) 表示，指針傳值，深拷貝，需要 free(shellCodeScript) 釋放内存;
                shellCodeScript = defaultShellCodeScript;  // C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/Python/Python311/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"、"C:/Criss/py/Scripts/python.exe C:/Criss/py/application.py IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // printf("C 語言調用操作系統（Linux、Window）控制臺命令列（shell、cmd）運行二進制可執行檔（.exe）的字符串參數爲：\n%s\n", shellCodeScript);  // "C:/Criss/Julia/Julia-1.9.3/bin/julia.exe -p 4 --project=C:/Criss/jl/ C:/Criss/jl/application.jl IP=::0 port=10001 Is_multi_thread=false number_Worker_threads=1"
                // const int lengthDefaultShellCodeScript = strlen(shellCodeScript);
                // printf("%d\n", lengthDefaultShellCodeScript);  // 254
        ...
        printf("解釋器（Exempli gratia: Julia、Python、Node.js、Java）可執行檔啓動路徑參數爲空：\nexecutableFile = %s\n", executableFile);  // 解釋器（Julia、Python、Node.js、Java）的二進制可執行檔啓動路徑參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"、"C:/Criss/Python/Python311/python.exe"、"C:/Criss/py/Scripts/python.exe"、"C:/Criss/Nodejs/node.exe"
        // printf("executableFile = %s\n", executableFile);  // 解釋器（Julia、Python、Node.js、Java）的二進制可執行檔啓動路徑參數："C:/Criss/Julia/Julia-1.9.3/bin/julia.exe"、"C:/Criss/Python/Python311/python.exe"、"C:/Criss/py/Scripts/python.exe"、"C:/Criss/Nodejs/node.exe"
        return 1;
    }
