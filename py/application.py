        ...
        if i > 0:
            ...
            if isinstance(sys.argv[i], str) and sys.argv[i] != "" and sys.argv[i].find("=", 0, int(len(sys.argv[i])-1)) != -1:
                ...
                if sys.argv[i].split("=", -1)[0] == "interface_Function":
                    ...
                    if isinstance(sys.argv[i].split("=", -1)[1], str) and sys.argv[i].split("=", -1)[1] != "" and sys.argv[i].split("=", -1)[1] == "Interface_File_Monitor" and type(Interface_File_Monitor).__name__ == 'classobj':
                        interface_Function = Interface_File_Monitor
                    if isinstance(sys.argv[i].split("=", -1)[1], str) and sys.argv[i].split("=", -1)[1] != "" and sys.argv[i].split("=", -1)[1] == "Interface_http_Server" and type(Interface_http_Server).__name__ == 'classobj':
                        interface_Function = Interface_http_Server
                    if isinstance(sys.argv[i].split("=", -1)[1], str) and sys.argv[i].split("=", -1)[1] != "" and sys.argv[i].split("=", -1)[1] == "Interface_http_Client" and type(Interface_http_Client).__name__ == 'classobj':
                        interface_Function = Interface_http_Client
                    # print("interface Function:", interface_Function)
