...
rem E-mail: chinaorcaz@gmail.com
rem Date: 歲在丙申
rem Operating system: Windows10 x86_64 Inter(R)-Core(TM)-m3-6Y30

rem 使用説明：在 Windows 系統的 cmd 控制臺命令列，使用如下指令，啓動執行;
rem C:\Criss> C:/Windows/System32/cmd.exe C:/Criss/startServer.bat C:/Criss/config.txt
...
set NoteHelp_11="configInstructions=interface_Function=file_Monitor,webPath=C:/Criss/html/,host=::0,port=10001,key=username:password,number_Worker_threads=1,isConcurrencyHierarchy=Tasks,is_monitor=False,time_sleep=0.02,monitor_dir=C:/Criss/Intermediary/,monitor_file=C:/Criss/Intermediary/intermediary_write_C.txt,output_dir=C:/Criss/Intermediary/,output_file=C:/Criss/Intermediary/intermediary_write_Python.txt,temp_cache_IO_data_dir=C:/Criss/temp/,is_Monitor_Concurrent=Multi-Threading,to_executable=C:/Criss/c2exe.exe,to_script=configFile=C:/Criss/config.txt"
set NoteHelp_12="executableFile=C:/Criss/Nodejs/node.exe"
set NoteHelp_13="scriptFile=C:/Criss/js/application.js"
set NoteHelp_14="configInstructions=interface_Function=file_Monitor,webPath=C:/Criss/html/,host=::0,port=10001,Key=username:password,number_cluster_Workers=0,is_monitor=false,delay=20,monitor_dir=C:/Criss/Intermediary/,monitor_file=C:/Criss/Intermediary/intermediary_write_C.txt,output_dir=C:/Criss/Intermediary/,output_file=C:/Criss/Intermediary/intermediary_write_Nodejs.txt,temp_cache_IO_data_dir=C:/Criss/temp/,number_Worker_process=0,to_executable=C:/Criss/c2exe.exe,to_script=configFile=C:/Criss/config.txt"
